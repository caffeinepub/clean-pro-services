...
export class Backend implements backendInterface {
    ...
    async createBooking(arg0: string, arg1: string, arg2: ServiceType, arg3: Time, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createBooking(arg0, arg1, to_candid_ServiceType_n1(this._uploadFile, this._downloadFile, arg2), arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "commercialCleaning" in value ? ServiceType.commercialCleaning : "residentialCleaning" in value ? ServiceType.residentialCleaning : "carDetailing" in value ? ServiceType.carDetailing : "carpetCleaning" in value ? ServiceType.carpetCleaning : value;
}
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.commercialCleaning ? {
        commercialCleaning: null
    } : value == ServiceType.residentialCleaning ? {
        residentialCleaning: null
    } : value == ServiceType.carDetailing ? {
        carDetailing: null
